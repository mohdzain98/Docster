            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                        <Link className={`nav-link ${location.pathname === "/product" || location.pathname === '/product/surfmind' || location.pathname === '/product/lexiclick'?"active":""}`} aria-current="page" to="/product" onClick={rollNavBack}>Product</Link>
                        </li>
                        <li className="nav-item">
